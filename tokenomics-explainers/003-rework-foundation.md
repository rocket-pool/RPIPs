...
<div class="flex-justify-v">
    <div>
        <img src="../assets/tokenomics-explainers/003-figure-1.png" alt="Figure 1" width="500px"></br>
        <i>Figure 1 - Current tokenomics pie</i>
    </div>
    <div>
        <br/>
        <img src="../assets/tokenomics-explainers/003-figure-2.png" alt="Figure 2" width="500px"></br>
        <i>Figure 2 - Proposed tokenomics pie</i>
    </div>
    <br/>
</div>

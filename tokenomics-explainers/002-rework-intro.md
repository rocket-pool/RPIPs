...
|-|-|-|
|**Existing Rocket Pool Node Operator**|I need RPL to create minipool validators. I have to remain collateralized at an RPL staked value of at least 10% of my borrowed ETH to receive RPL issuance rewards. My commission is 14% of my borrowed ETH.|I do not need RPL to create megapool validators. My commission is 3.5% of my borrowed ETH. If I choose to stake RPL (which makes it vote-eligible) I will receive additional ETH rewards from voter share (5.0% of protocol revenue from all megapools) proportional to my vote-eligible RPL. I do not have a minimum staked RPL requirement (or "cliff") to maintain eligibility for voter share rewards, but my max vote eligibility is an RPL staked value of 150% of my bonded ETH. I will also benefit from either surplus share value accrual to RPL (5.5% of protocol revenue from all megapools) or a 5.5% increase to voter share. I will no longer receive RPL issuance
|**rETH holder**|My staking rewards are a function of solo staking APY and the fee I am charged by Rocket Pool. Currently my rewards are ~86% of solo staking APY since I am charged of a fee of ~14%. The fee is considered revenue for Rocket Pool and is paid to NOs as commission for their services.|My staking rewards are a function of solo staking APY and the fee I am charged by Rocket Pool. Initially my rewards are unchanged at ~86% of solo staking APY since I will still be charged of a fee of ~14%. The fee is considered revenue for Rocket Pool and will be split by the pDAO to several targets. The relative sizes and total sum of the revenue splits may be modified by future pDAO votes.|
|**Passive RPL Holder**|Holding RPL is speculation on the liquid staking narrative and the utility of RPL as a bond.|In addition to the liquid staking narrative, holding RPL is speculation that the tokenomics changes will cause rETH supply to grow and generate surplus ETH revenue, which **may** be used to accrue value to RPL (via buy+burn or buy+LP) or may solely go to NOs staking RPL (through voter share rewards).|

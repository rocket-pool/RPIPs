...
This version implements RPIP-30 following the suggestions [here](https://github.com/rocket-pool/rocketpool-research/blob/dae123409c636aab8c7aee5a1b62f34cfc4a5626/Merkle%20Rewards%20System/misc/patches-rpip-30-suggestions.md)


### Changes since `v7`

The following updates have been made from [v7](https://github.com/rocket-pool/rocketpool-research/blob/dae123409c636aab8c7aee5a1b62f34cfc4a5626/Merkle%20Rewards%20System/legacy/rewards-calculation-spec-v7.md) of the spec.
...
That is, if `x` is `40 Eth`, the highest power of two that is less than 40 Eth is 32 Eth, and the most significant bit of 0b0100000 (32 in binary) is at index 5 (counting the least significant bit as index 0), so `exponent` is 5.

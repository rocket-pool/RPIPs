---
rpip: XX
title: Updating of Grants Management Committee 3 – Membership Reduction
...
- RPIP-40 superceded RPIP-26, it revises the conflict of interest section to allow GMC members to participate in grants that have not been identified as competing grants, it adds additional clarity on GMC members participating in bounties, it makes an adjustment to the application deadline within the schedule, it restores the 'Selection and Governance' section that was incorrectly removed in RPIP-26.
- This RPIP superceds RPIP-40, it reduces the number of Grants and Bounties Management Committee (GMC) members from nine (9) to seven (7). 
...
The Grants and Bounties Management Committee (GMC) was originally expanded to nine members to facilitate subcommittees across multiple categories of applications. Over time, however, the number of applications received has declined, subcommittees are not utilized as much, and spending projections for the upcoming year are lower. Reducing the GMC to seven members aligns its structure with current workload and fiscal needs while maintaining sufficient capacity and diversity for effective governance.
...
- The GMC SHALL contain seven individuals, except in cases of vacancies.
...
- [RPIP-18: Updating of Grants Management Committee](https://rpips.rocketpool.net/RPIPs/RPIP-18)  
- [RPIP-26: Updating of Grants Management Committee 1](https://rpips.rocketpool.net/RPIPs/RPIP-26)  
- [RPIP-40: Updating of Grants Management Committee 2](https://rpips.rocketpool.net/RPIPs/RPIP-40)  

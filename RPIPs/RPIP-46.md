...
5. `node_operator_commission_share` and `surplus_share`, MAY be updated by an address in the `allowlisted_controllers` array
...
9. `voter_share` SHALL NOT be controllable by pDAO vote
10. The initial settings SHALL be:
    1. `node_operator_commission_share`: 3.5%
    2. `node_operator_commission_share_council_adder`: 0%
    3. `voter_share`: 5%
    4. `surplus_share`: 5.5%
    5. `max_node_operator_commission_share_council_adder`: 1%
